...
interface IProjectDisplay extends ReactThreeFiber.Object3DNode<THREE.Group, typeof THREE.Group> {
  currTxt?: string | null;
}

const ProjectDisplay: React.FC<IProjectDisplay> = ({ currTxt, ...props }) => {
  const group = useRef<THREE.Group>(null)
  const { nodes, materials } = useGLTF('/models_3d/computer.glb') as GLTFResult
  // const { actions } = useAnimations<GLTFActions>(animations, group)

  
  const txt = useTexture(currTxt ? currTxt : "/image/projects/test-image.png")
...
useGLTF.preload('/models_3d/computer.glb')
