      ...
      <div className="grid lg:grid-cols-2 grid-cols-1 mt-12 gap-5 w-full">
        <div className="flex flex-col gap-3 relative sm:p-10 py-10 px-5 shadow-2xl shadow-black-200">
          ...
          <div className="flex flex-col gap-5 text-white-600 my-5">
            ...
            <p className="projectText text-base">Podcastr is a revolutionary Software-as-a-Service platform that transforms the way podcasts are created. With advanced AI-powered features like text-to-multiple-voices functionality, it allows creators to generate diverse voiceovers from a single text input.</p>
          </div>
          ...
          <div className="flex justify-between items-center mt-7">
            ...
            <button className="arrow-btn">
              <img src="/image/right-arrow.png" alt="right arrow" className="w-4 h-4" />
            </button>
          </div>
        </div>
